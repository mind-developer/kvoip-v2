    ...
    <StyledChatbotActionMenuContainer>
      ...
      >
        ...
        <SelectableListItem itemId="add-text-node">
          <MenuItem LeftIcon={IconTextSize} text="+ Text node" />
        </SelectableListItem>
        <SelectableListItem itemId="add-text-node">
          <MenuItem LeftIcon={IconPhoto} text="+ Image node" />
        </SelectableListItem>
        <SelectableListItem itemId="add-text-node">
          <MenuItem LeftIcon={IconFileImport} text="+ File node" />
        </SelectableListItem>
        <SelectableListItem itemId="add-text-node">
          <MenuItem LeftIcon={IconHierarchy} text="+ Conditional node" />
        </SelectableListItem>
      </StyledSelectableList>
    </StyledChatbotActionMenuContainer>
  );
