...
export const financialRegistersAllViews = (
  ...
  if (!financialRegisterObjectMetadata) {
    return [];
  }
        ...
        },
        {
          fieldMetadataId:
            financialRegisterObjectMetadata.fields.find(
              (field) =>
                field.standardId ===
                FINANCIAL_REGISTER_STANDARD_FIELD_IDS.amount,
            )?.id ?? '',
          position: 2,
          isVisible: true,
          size: 150,
        ...
        },
        {
          fieldMetadataId:
            financialRegisterObjectMetadata.fields.find(
              (field) =>
                field.standardId ===
                FINANCIAL_REGISTER_STANDARD_FIELD_IDS.status,
            )?.id ?? '',
          position: 4,
          isVisible: true,
          size: 120,
