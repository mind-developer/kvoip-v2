  ...
  public getDefaultUserWorkspacePermissions = () =>
    ({
      ...
      permissionFlags: {
        ...
        [PermissionFlagType.CLIENT_CHATS]: false,
        [PermissionFlagType.INTERNAL_CHATS]: false,
        [PermissionFlagType.TRACEABLE_LINKS]: false,
        [PermissionFlagType.FINANCIAL_CLOSING]: false,
      },
      objectPermissions: {},
      objectsPermissions: {},
