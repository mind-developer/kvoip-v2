...
export class FinancialClosingExecutionWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId:
      FINANCIAL_CLOSING_EXECUTION_STANDARD_FIELD_IDS.financialRegisters,
    type: RelationType.ONE_TO_MANY,
    label: msg`Generated Registers`,
    description: msg`Financial registers generated by this closing`,
    icon: 'IconReceipt',
    inverseSideTarget: () => FinancialRegisterWorkspaceEntity,
    inverseSideFieldKey: 'closingExecution',
