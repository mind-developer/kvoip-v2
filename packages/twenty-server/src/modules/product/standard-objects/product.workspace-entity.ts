...
export class ProductWorkspaceEntity extends BaseWorkspaceEntity {
  @WorkspaceField({
    ...
    icon: 'IconClipboardList',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.PRODUCT_NAME,
    },
  })
  @WorkspaceIsNullable()
  name: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconSettings',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.UNIT_OF_MEASURE,
    },
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    icon: 'IconBarcode',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.NCM,
    },
  })
  @WorkspaceIsNullable()
  ncm: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconFileCode',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.CFOP,
    },
  })
  @WorkspaceIsNullable()
  cfop: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconFileCode',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.CEST,
    },
  })
  @WorkspaceIsNullable()
  cest: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconBox',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.COMMERCIAL_UNIT,
    },
  })
  @WorkspaceIsNullable()
  unit: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconReceiptTax',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.CST_PIS_COFINS,
    },
  })
  @WorkspaceIsNullable()
  cstPis: string;
  ...
  @WorkspaceField({
    ...
    icon: 'IconNotes',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.SERVICE_LIST_ITEM,
    },
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    icon: 'IconNotes',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.MUNICIPAL_TAX_CODE,
    },
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    icon: 'IconNotes',
    settings: {
      validation: TEXT_VALIDATION_PATTERNS.CLASSIFICATION,
    },
  })
  @WorkspaceIsNullable()
